...
Codex SEO (技术审计): `Skill("Codex-seo:seo-technical")`, `Skill("Codex-seo:seo-schema")`, 等

**如果你是第一次用:**

1. 运行 `./setup.sh` 克隆三个外部技能包 (superseo-skills, seomachine, Codex-seo)
